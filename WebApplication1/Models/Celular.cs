...
namespace WebApplication1.Models
{
    public class Celular
    {
        ...
        public static void GerarLista(HttpSessionStateBase session)
        {
            ...
            lista.Add(new Celular { Numero = 6, Marca = "Iphone", Novo = false });
            lista.Add(new Celular { Numero = 8, Marca = "Motorola", Novo = true });
            lista.Add(new Celular { Numero = 24, Marca = "Samsung", Novo = true });
