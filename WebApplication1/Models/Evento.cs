...
namespace WebApplication1.Models
{
    public class Evento
    {
        ...
        public static void GerarLista(HttpSessionStateBase session)
        {
            ...
            lista.Add(new Evento { Local = "Fatec Sorocaba", Data = DateTime.Now });
            lista.Add(new Evento { Local = "Etec Fernando Prestes", Data = DateTime.Now });
            lista.Add(new Evento { Local = "Face oculta da Lua", Data = DateTime.Now });
